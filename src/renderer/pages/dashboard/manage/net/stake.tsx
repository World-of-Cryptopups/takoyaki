...
const ManageNetModalStakeAction = () => {
      ...
      .transact({
        action: {
          ...
          data: {
            ...
            stake_net_quantity: String(`${amount.toFixed(8)} WAX`),
            stake_cpu_quantity: String(`${(0).toFixed(8)} WAX`),
            transfer: false,
          },
        },
      })
      .then((r) => {
        toast.success('Sucessfully staked NET to your account.');
    ...
    <div>
      <div className="flex flex-col my-2">
        ...
        <input
          ...
          type="number"
          name="amount"
          placeholder="Amount of WAX to stake"
...
export default ManageNetModalStakeAction;
