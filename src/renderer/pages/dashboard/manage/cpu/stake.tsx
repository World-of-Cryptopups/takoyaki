...
const ManageCpuModalStakeAction = () => {
      ...
      .transact({
        action: {
          ...
          data: {
            ...
            stake_cpu_quantity: String(`${amount.toFixed(8)} WAX`),
            stake_net_quantity: String(`${(0).toFixed(8)} WAX`),
            transfer: false,
          },
        },
      })
      .then((r) => {
        toast.success('Sucessfully staked CPU to your account.');
...
export default ManageCpuModalStakeAction;
